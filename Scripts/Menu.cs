...
public class Menu : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Mission.Mission.STATEPIVOT == 2) && (isSound == false))
        {
    ...
    void OnGUI()
    {
        ...
        switch (Mission.Mission.STATEPIVOT)
        {
            case 0:
                Mission.Mission.STATEPIVOT = 0;
                SplashScreen();
                break;
            case 1:
                Login();
    ...
    private void About()
    {
        ...
        GUI.Label(new Rect(10, 155, 600, 500), credits + version, design.StyleText
            (futura_font, 16, TextAnchor.MiddleLeft, Color.white));


        //RETURN BUTTON
        if (GUI.Button(new Rect(10, Screen.height - 80, 150, 60), new GUIContent("RETURN", "RETURN"), 
            design.StyleButton(futura_font, 24, Color.white, button_blue, button_blue_hover)))
        {
            Mission.Mission.STATEPIVOT = 2;
        }
